...
food_category = BC.BudgetCategory("Food", 500)
...
food_category.set_category_name("Dining")
food_category.set_allocated_budget(1000)
print(f"\nFood budget updated to {food_category.get_category_name()} budget with ${food_category.get_allocated_budget()} allocated!")
...
print("\nBegin Gaming Budget Output:")
gaming_category = BC.BudgetCategory("Gaming", 150)
gaming_category.set_allocated_budget(-50)
print(f"${gaming_category.get_allocated_budget()} allocated to the {gaming_category.get_category_name()} Budget!")
gaming_category.add_expense(200)
gaming_category.display_category_summary()
